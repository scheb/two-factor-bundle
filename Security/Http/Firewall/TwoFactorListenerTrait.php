...
trait TwoFactorListenerTrait
{
    ...
    public function __construct(
        ...
        $this->options = array_merge(TwoFactorListenerInterface::DEFAULT_OPTIONS, $options);
    ...
    public function doHandleOrInvoke(/* RequestEvent */$event): void
    {
